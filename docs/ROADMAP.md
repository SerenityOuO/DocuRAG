...
- v0.6.0: 06-01 OCR provider interface、06-02 RAG provider interface、06-03 processing status 與 06-04 chunk citation schema 已完成；processing job contract 待執行。
