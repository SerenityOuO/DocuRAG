...
- v0.29.0 follow-up hardening: Ollama VLM response parsing 已支援 `response` / `thinking` / fenced JSON、金額字串、confidence label 與 line item alias；frontend 後台檔案選擇可多選並逐檔走既有 ingestion flow，不 bump version。
