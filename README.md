...
- Default-on vector retrieval、default-on rerank、hybrid search、LLM-as-judge、answer faithfulness scoring、eval dashboard、LLM generation default-on path、streaming UI、OpenAI API 或 vLLM serving。
