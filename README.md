...
- v0.24.0 backlog 已新增 VLM / Parser Minimal MVP：下一步會先做 VLM-compatible parser contract、deterministic invoice parser fallback、parse / fields API 與 structured fields surface；這不是 production VLM parser。
