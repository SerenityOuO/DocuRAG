...
- Production-grade K8s deployment、observability runtime 或 production training pipeline。Phase 39 `39-02` 目前只完成 baseline manifests 與文件化 dry-run / rollout boundary。
