...
- NATS runtime service、async worker、queue、production PostgreSQL operation、destructive migration、production login runtime、SSO、OAuth、MFA、enterprise identity provider、production audit pipeline，或 Redis session rotation / worker lock runtime。
