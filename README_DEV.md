...
- Redis、NATS、async worker、queue、PostgreSQL runtime、實際 migration 檔、資料庫 schema、正式登入、正式權限或 production RBAC。
