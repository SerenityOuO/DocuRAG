...
- [ ] v0.7.0: Real OCR Provider Spike 進行中；07-01 已選定 PaddleOCR，07-02 已新增 provider adapter，07-03 已完成 output normalization（Docker validation 需待 Docker Desktop daemon 可用後重跑），07-04 待執行。
